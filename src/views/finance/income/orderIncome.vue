<template>
    <div class="income-detail rider-container">
        <div class="rider-switch">
            <div class="tab active">订单收益表</div>
        </div>
        ...
        <div class="rider-table">
            <el-table :size='$size' fit :data='tableData' v-loading="loading" element-loading-background='rgba(0,0,0,0.8)'>
                ...
                <el-table-column label='配送订单号' prop='dispatchOrderNo' min-width='140'></el-table-column>
                <el-table-column label='订单类型' prop='dispatchOrderNo' min-width='100'>
                ...
                <el-table-column label='平台收入金额' min-width='100'>
                ...
                <el-table-column label='净收入' min-width='100'>
                    <template slot-scope='scope'>{{(scope.row.extraAmount-scope.row.drawOutAmount)|formatPrice}}</template>
                </el-table-column>
